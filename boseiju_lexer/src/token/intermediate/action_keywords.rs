...
impl<'src> TryFrom<&crate::LexerSpan<'src>> for TensedActionKeyword {
    ...
    fn try_from(span: &crate::LexerSpan) -> Result<Self, ()> {
        match span.text {
            "deal" => Ok(Tensed::base_form(ActionKeyword::Deals {
                #[cfg(feature = "spanned_tree")]
                span: span.into(),
            })),
            "deals" => Ok(Tensed::third_person_singular_present(ActionKeyword::Deals {
                #[cfg(feature = "spanned_tree")]
                span: span.into(),
            })),
            "dealt" => Ok(Tensed::simple_past(ActionKeyword::Deals {
                #[cfg(feature = "spanned_tree")]
                span: span.into(),
            })),
            "dealing" => Ok(Tensed::present_participle(ActionKeyword::Deals {
                #[cfg(feature = "spanned_tree")]
                span: span.into(),
            })),
