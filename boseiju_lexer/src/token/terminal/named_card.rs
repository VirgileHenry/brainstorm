...
impl Default for NamedCard {
    fn default() -> Self {
        Self::ChandraBoldPyromancer {
            #[cfg(feature = "spanned_tree")]
...
#[cfg(feature = "spanned_tree")]
impl boseiju_span::Spanned for NamedCard {
...
impl<'src> TryFrom<&crate::LexerSpan<'src>> for NamedCard {
    type Error = ();
    fn try_from(span: &crate::LexerSpan) -> Result<Self, ()> {
        match span.text {
            "advocate of the beast" => Ok(Self::AdvocateOfTheBeast {
                #[cfg(feature = "spanned_tree")]
                span: span.into(),
            }),
            "ajani, inspiring leader" => Ok(Self::AjaniInspiringLeader {
                #[cfg(feature = "spanned_tree")]
                span: span.into(),
            }),
            "alpine watchdog" | "~ watchdog" => Ok(Self::AlpineWatchdog {
                #[cfg(feature = "spanned_tree")]
                span: span.into(),
            }),
            "altanak, the thrice-called" => Ok(Self::AltanakTheThriceCalled {
                #[cfg(feature = "spanned_tree")]
                span: span.into(),
            }),
            "arachnus web" | "~ web" => Ok(Self::ArachnusWeb {
                #[cfg(feature = "spanned_tree")]
                span: span.into(),
            }),
            "argoth, sanctum of nature" => Ok(Self::ArgothSanctumOfNature {
                #[cfg(feature = "spanned_tree")]
                span: span.into(),
            }),
            "ashiok, sculptor of fears" => Ok(Self::AshiokSculptorOfFears {
                #[cfg(feature = "spanned_tree")]
                span: span.into(),
            }),
            "basri, devoted paladin" => Ok(Self::BasriDevotedPaladin {
                #[cfg(feature = "spanned_tree")]
                span: span.into(),
            }),
            "black lotus" => Ok(Self::BlackLotus {
                #[cfg(feature = "spanned_tree")]
                span: span.into(),
            }),
            "blood artist" => Ok(Self::BloodArtist {
                #[cfg(feature = "spanned_tree")]
                span: span.into(),
            }),
            "bogbrew witch" => Ok(Self::BogbrewWitch {
                #[cfg(feature = "spanned_tree")]
                span: span.into(),
            }),
            "boulderborn dragon" => Ok(Self::BoulderbornDragon {
                #[cfg(feature = "spanned_tree")]
                span: span.into(),
            }),
            "brambleweft behemoth" => Ok(Self::BrambleweftBehemoth {
                #[cfg(feature = "spanned_tree")]
                span: span.into(),
            }),
            "braingeyser" => Ok(Self::Braingeyser {
                #[cfg(feature = "spanned_tree")]
                span: span.into(),
            }),
            "breathstealer" => Ok(Self::Breathstealer {
                #[cfg(feature = "spanned_tree")]
                span: span.into(),
            }),
            "bride's gown" => Ok(Self::BridesGown {
                #[cfg(feature = "spanned_tree")]
                span: span.into(),
            }),
            "bruna, the fading light" => Ok(Self::BrunaTheFadingLight {
                #[cfg(feature = "spanned_tree")]
                span: span.into(),
            }),
            "bubbling cauldron" => Ok(Self::BubblingCauldron {
                #[cfg(feature = "spanned_tree")]
                span: span.into(),
            }),
            "chandra, bold pyromancer" => Ok(Self::ChandraBoldPyromancer {
                #[cfg(feature = "spanned_tree")]
                span: span.into(),
            }),
            "chandra, flame's catalyst" => Ok(Self::ChandraFlamesCatalyst {
                #[cfg(feature = "spanned_tree")]
                span: span.into(),
            }),
            "chandra, flame's fury" => Ok(Self::ChandraFlamesFury {
                #[cfg(feature = "spanned_tree")]
                span: span.into(),
            }),
            "chandra, pyrogenius" => Ok(Self::ChandraPyrogenius {
                #[cfg(feature = "spanned_tree")]
                span: span.into(),
            }),
            "command tower" => Ok(Self::CommandTower {
                #[cfg(feature = "spanned_tree")]
                span: span.into(),
            }),
            "crown of empires" => Ok(Self::CrownOfEmpires {
                #[cfg(feature = "spanned_tree")]
                span: span.into(),
            }),
            "disenchant" => Ok(Self::Disenchant {
                #[cfg(feature = "spanned_tree")]
                span: span.into(),
            }),
            "domri, city smasher" => Ok(Self::DomriCitySmasher {
                #[cfg(feature = "spanned_tree")]
                span: span.into(),
            }),
            "dovin, architect of law" => Ok(Self::DovinArchitectOfLaw {
                #[cfg(feature = "spanned_tree")]
                span: span.into(),
            }),
            "dragonstorm globe" | "~ globe" => Ok(Self::DragonstormGlobe {
                #[cfg(feature = "spanned_tree")]
                span: span.into(),
            }),
            "eight-and-a-half-tails" => Ok(Self::EightAndAHalfTails {
                #[cfg(feature = "spanned_tree")]
                span: span.into(),
            }),
            "eivor, battle-ready" => Ok(Self::EivorBattleReady {
                #[cfg(feature = "spanned_tree")]
                span: span.into(),
            }),
            "empyrial archangel" => Ok(Self::EmpyrialArchangel {
                #[cfg(feature = "spanned_tree")]
                span: span.into(),
            }),
            "feral shadow" => Ok(Self::FeralShadow {
                #[cfg(feature = "spanned_tree")]
                span: span.into(),
            }),
            "festering newt" => Ok(Self::FesteringNewt {
                #[cfg(feature = "spanned_tree")]
                span: span.into(),
            }),
            "flame burst" => Ok(Self::FlameBurst {
                #[cfg(feature = "spanned_tree")]
                span: span.into(),
            }),
            "galactus, devourer of worlds" => Ok(Self::GalactusDevourerOfWorlds {
                #[cfg(feature = "spanned_tree")]
                span: span.into(),
            }),
            "garruk, savage herald" => Ok(Self::GarrukSavageHerald {
                #[cfg(feature = "spanned_tree")]
                span: span.into(),
            }),
            "gideon, martial paragon" => Ok(Self::GideonMartialParagon {
                #[cfg(feature = "spanned_tree")]
                span: span.into(),
            }),
            "gideon, the oathsworn" => Ok(Self::GideonTheOathsworn {
                #[cfg(feature = "spanned_tree")]
                span: span.into(),
            }),
            "god-pharaoh's gift" => Ok(Self::GodPharaohsGift {
                #[cfg(feature = "spanned_tree")]
                span: span.into(),
            }),
            "godsire" => Ok(Self::Godsire {
                #[cfg(feature = "spanned_tree")]
                span: span.into(),
            }),
            "groom's finery" => Ok(Self::GroomsFinery {
                #[cfg(feature = "spanned_tree")]
                span: span.into(),
            }),
            "halvar, god of battle" => Ok(Self::HalvarGodOfBattle {
                #[cfg(feature = "spanned_tree")]
                span: span.into(),
            }),
            "hammer of nazahn" | "hammer of ~" => Ok(Self::HammerOfNazahn {
                #[cfg(feature = "spanned_tree")]
                span: span.into(),
            }),
            "eye of vecna" => Ok(Self::EyeOfVecna {
                #[cfg(feature = "spanned_tree")]
                span: span.into(),
            }),
            "ezio, blade of vengeance" => Ok(Self::EzioBladeOfVengeance {
                #[cfg(feature = "spanned_tree")]
                span: span.into(),
            }),
            "fang, fearless l'cie" => Ok(Self::FangFearlessLCie {
                #[cfg(feature = "spanned_tree")]
                span: span.into(),
            }),
            "hand of vecna" => Ok(Self::HandOfVecna {
                #[cfg(feature = "spanned_tree")]
                span: span.into(),
            }),
            "hanweir garrison" => Ok(Self::HanweirGarrison {
                #[cfg(feature = "spanned_tree")]
                span: span.into(),
            }),
            "heart-piercer bow" => Ok(Self::HeartPiercerBow {
                #[cfg(feature = "spanned_tree")]
                span: span.into(),
            }),
            "hellkite overlord" => Ok(Self::HellkiteOverlord {
                #[cfg(feature = "spanned_tree")]
                span: span.into(),
            }),
            "helm of kaldra" => Ok(Self::HelmOfKaldra {
                #[cfg(feature = "spanned_tree")]
                span: span.into(),
            }),
            "igneous cur" => Ok(Self::IgneousCur {
                #[cfg(feature = "spanned_tree")]
                span: span.into(),
            }),
            "jace, arcane strategist" => Ok(Self::JaceArcaneStrategist {
                #[cfg(feature = "spanned_tree")]
                span: span.into(),
            }),
            "jace, ingenious mind-mage" => Ok(Self::JaceIngeniousMindMage {
                #[cfg(feature = "spanned_tree")]
                span: span.into(),
            }),
            "jiang yanggu" => Ok(Self::JiangYanggu {
                #[cfg(feature = "spanned_tree")]
                span: span.into(),
            }),
            "keeper of kookus" | "keeper of ~" => Ok(Self::KeeperOfKookus {
                #[cfg(feature = "spanned_tree")]
                span: span.into(),
            }),
            "labyrinth of skophos" | "labyrinth of ~" => Ok(Self::LabyrinthOfSkophos {
                #[cfg(feature = "spanned_tree")]
                span: span.into(),
            }),
            "lightning bolt" => Ok(Self::LightningBolt {
                #[cfg(feature = "spanned_tree")]
                span: span.into(),
            }),
            "liliana, death mage" => Ok(Self::LilianaDeathMage {
                #[cfg(feature = "spanned_tree")]
                span: span.into(),
            }),
            "liliana, death wielder" => Ok(Self::LilianaDeathWielder {
                #[cfg(feature = "spanned_tree")]
                span: span.into(),
            }),
            "magnifying glass" => Ok(Self::MagnifyingGlass {
                #[cfg(feature = "spanned_tree")]
                span: span.into(),
            }),
            "midnight clock" => Ok(Self::MidnightClock {
                #[cfg(feature = "spanned_tree")]
                span: span.into(),
            }),
            "midnight scavengers" => Ok(Self::MidnightScavengers {
                #[cfg(feature = "spanned_tree")]
                span: span.into(),
            }),
            "mine worker" => Ok(Self::MineWorker {
                #[cfg(feature = "spanned_tree")]
                span: span.into(),
            }),
            "monk of the open hand" => Ok(Self::MonkOfTheOpenHand {
                #[cfg(feature = "spanned_tree")]
                span: span.into(),
            }),
            "muscle burst" => Ok(Self::MuscleBurst {
                #[cfg(feature = "spanned_tree")]
                span: span.into(),
            }),
            "mu yanling" => Ok(Self::MuYanling {
                #[cfg(feature = "spanned_tree")]
                span: span.into(),
            }),
            "mu yanling, celestial wind" => Ok(Self::MuYanlingCelestialWind {
                #[cfg(feature = "spanned_tree")]
                span: span.into(),
            }),
            "nicol bolas, the deceiver" => Ok(Self::NicolBolasTheDeceiver {
                #[cfg(feature = "spanned_tree")]
                span: span.into(),
            }),
            "nissa, genesis mage" => Ok(Self::NissaGenesisMage {
                #[cfg(feature = "spanned_tree")]
                span: span.into(),
            }),
            "nissa, nature's artisan" => Ok(Self::NissaNaturesArtisan {
                #[cfg(feature = "spanned_tree")]
                span: span.into(),
            }),
            "oko, the trickster" => Ok(Self::OkoTheTrickster {
                #[cfg(feature = "spanned_tree")]
                span: span.into(),
            }),
            "peer through depths" => Ok(Self::PeerThroughDepths {
                #[cfg(feature = "spanned_tree")]
                span: span.into(),
            }),
            "phyrexian dragon engine" => Ok(Self::PhyrexianDragonEngine {
                #[cfg(feature = "spanned_tree")]
                span: span.into(),
            }),
            "plant worker" => Ok(Self::PlantWorker {
                #[cfg(feature = "spanned_tree")]
                span: span.into(),
            }),
            "prince of thralls" => Ok(Self::PrinceOfThralls {
                #[cfg(feature = "spanned_tree")]
                span: span.into(),
            }),
            "ral, caller of storms" => Ok(Self::RalCallerOfStorms {
                #[cfg(feature = "spanned_tree")]
                span: span.into(),
            }),
            "reach through mists" => Ok(Self::ReachThroughMists {
                #[cfg(feature = "spanned_tree")]
                span: span.into(),
            }),
            "regrowth" => Ok(Self::Regrowth {
                #[cfg(feature = "spanned_tree")]
                span: span.into(),
            }),
            "rowan, fearless sparkmage" => Ok(Self::RowanFearlessSparkmage {
                #[cfg(feature = "spanned_tree")]
                span: span.into(),
            }),
            "scepter of empires" => Ok(Self::ScepterOfEmpires {
                #[cfg(feature = "spanned_tree")]
                span: span.into(),
            }),
            "shield of kaldra" => Ok(Self::ShieldOfKaldra {
                #[cfg(feature = "spanned_tree")]
                span: span.into(),
            }),
            "shivan dragon" => Ok(Self::ShivanDragon {
                #[cfg(feature = "spanned_tree")]
                span: span.into(),
            }),
            "silver surfer, galactus's herald" | "silver surfer, ~'s herald" => Ok(Self::SilverSurferGalactussHerald {
                #[cfg(feature = "spanned_tree")]
                span: span.into(),
            }),
            "sorin, vampire lord" => Ok(Self::SorinVampireLord {
                #[cfg(feature = "spanned_tree")]
                span: span.into(),
            }),
            "sphinx sovereign" => Ok(Self::SphinxSovereign {
                #[cfg(feature = "spanned_tree")]
                span: span.into(),
            }),
            "spitting drake" => Ok(Self::SpittingDrake {
                #[cfg(feature = "spanned_tree")]
                span: span.into(),
            }),
            "sunlit hoplite" => Ok(Self::SunlitHoplite {
                #[cfg(feature = "spanned_tree")]
                span: span.into(),
            }),
            "sword of kaldra" => Ok(Self::SwordOfKaldra {
                #[cfg(feature = "spanned_tree")]
                span: span.into(),
            }),
            "tardis" => Ok(Self::Tardis {
                #[cfg(feature = "spanned_tree")]
                span: span.into(),
            }),
            "teferi, timebender" => Ok(Self::TeferiTimebender {
                #[cfg(feature = "spanned_tree")]
                span: span.into(),
            }),
            "teferi, timeless voyager" => Ok(Self::TeferiTimelessVoyager {
                #[cfg(feature = "spanned_tree")]
                span: span.into(),
            }),
            ...
            "tezzeret, master of metal" => Ok(Self::TezzeretMasterOfMetal {
                #[cfg(feature = "spanned_tree")]
                span: span.into(),
            }),
            "the animus" => Ok(Self::TheAnimus {
                #[cfg(feature = "spanned_tree")]
                span: span.into(),
            }),
            "the mightstone and weakstone" => Ok(Self::TheMightstoneAndWeakstone {
                #[cfg(feature = "spanned_tree")]
                span: span.into(),
            }),
            "the spear of leonidas" => Ok(Self::TheSpearOfLeonidas {
                #[cfg(feature = "spanned_tree")]
                span: span.into(),
            }),
            "the underworld cookbook" => Ok(Self::TheUnderworldCookbook {
                #[cfg(feature = "spanned_tree")]
                span: span.into(),
            }),
            "the unspeakable" => Ok(Self::TheUnspeakable {
                #[cfg(feature = "spanned_tree")]
                span: span.into(),
            }),
            "thinking cap" => Ok(Self::ThinkingCap {
                #[cfg(feature = "spanned_tree")]
                span: span.into(),
            }),
            "throne of empires" => Ok(Self::ThroneOfEmpires {
                #[cfg(feature = "spanned_tree")]
                span: span.into(),
            }),
            "tower worker" => Ok(Self::TowerWorker {
                #[cfg(feature = "spanned_tree")]
                span: span.into(),
            }),
            "vial of dragonfire" => Ok(Self::VialOfDragonfire {
                #[cfg(feature = "spanned_tree")]
                span: span.into(),
            }),
            "viashivan dragon" => Ok(Self::ViashivanDragon {
                #[cfg(feature = "spanned_tree")]
                span: span.into(),
            }),
            "vivien, nature's avenger" => Ok(Self::VivienNaturesAvenger {
                #[cfg(feature = "spanned_tree")]
                span: span.into(),
            }),
            "vraska, regal gorgon" => Ok(Self::VraskaRegalGorgon {
                #[cfg(feature = "spanned_tree")]
                span: span.into(),
            }),
            "vraska, scheming gorgon" => Ok(Self::VraskaSchemingGorgon {
                #[cfg(feature = "spanned_tree")]
                span: span.into(),
            }),
            "wastes" => Ok(Self::Wastes {
                #[cfg(feature = "spanned_tree")]
                span: span.into(),
            }),
            _ => Err(()),
