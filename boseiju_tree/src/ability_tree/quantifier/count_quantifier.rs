...
#[cfg(feature = "spanned_tree")]
impl boseiju_span::Spanned for CountQuantifier {
    fn span(&self) -> boseiju_span::Span {
        self.span
    }
}

impl idris::Idris for CountQuantifier {
    const COUNT: usize = 1;
    fn id(&self) -> usize {
        0
    }
...
impl Default for CountQuantifier {
    fn default() -> Self {
        Self {
