...
impl crate::Node for DamageReceiver {
    fn node_id(&self) -> usize {
        use idris::Idris;
        crate::NodeKind::DamageReceiver.id()
    }

    fn children(&self) -> arrayvec::ArrayVec<&dyn Node, MAX_CHILDREN_PER_NODE> {
        let mut children = arrayvec::ArrayVec::new_const();
        match self {
            Self::AnyTarget(child) => children.push(child as &dyn Node),
...
impl boseiju_span::Spanned for DamageReceiver {
...
impl Node for AnyTarget {
    fn node_id(&self) -> usize {
        use idris::Idris;
        crate::NodeKind::AnyTarget.id()
    }
...
#[cfg(feature = "spanned_tree")]
impl boseiju_span::Spanned for AnyTarget {
    fn span(&self) -> boseiju_span::Span {
        self.span
    }
}

impl Default for AnyTarget {
    fn default() -> Self {
        Self {
            #[cfg(feature = "spanned_tree")]
