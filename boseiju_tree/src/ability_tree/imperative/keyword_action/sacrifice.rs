...
impl crate::Node for SacrificeKeywordAction {
    fn node_id(&self) -> usize {
        use crate::node_kind::KeywordActionNodeKind;
        use idris::Idris;

        crate::NodeKind::KeywordAction(KeywordActionNodeKind::Sacrifice).id()
    }
...
#[cfg(feature = "spanned_tree")]
impl boseiju_span::Spanned for SacrificeKeywordAction {
...
impl Default for SacrificeKeywordAction {
    fn default() -> Self {
        Self {
