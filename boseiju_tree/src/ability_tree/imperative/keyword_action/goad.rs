...
impl crate::Node for GoadKeywordAction {
    fn node_id(&self) -> usize {
        use crate::node_kind::KeywordActionNodeKind;
        use idris::Idris;

        crate::NodeKind::KeywordAction(KeywordActionNodeKind::Goad).id()
    }
...
#[cfg(feature = "spanned_tree")]
impl boseiju_span::Spanned for GoadKeywordAction {
...
impl Default for GoadKeywordAction {
    fn default() -> Self {
        Self {
