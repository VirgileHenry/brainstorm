...
impl crate::Node for PlayKeywordAction {
    fn node_id(&self) -> usize {
        use crate::node_kind::KeywordActionNodeKind;
        use idris::Idris;

        crate::NodeKind::KeywordAction(KeywordActionNodeKind::Play).id()
    }
...
#[cfg(feature = "spanned_tree")]
impl boseiju_span::Spanned for PlayKeywordAction {
...
impl Default for PlayKeywordAction {
    fn default() -> Self {
        Self {
