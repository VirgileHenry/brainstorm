...
impl crate::Node for ScryKeywordAction {
    fn node_id(&self) -> usize {
        use crate::node_kind::KeywordActionNodeKind;
        use idris::Idris;

        crate::NodeKind::KeywordAction(KeywordActionNodeKind::Scry).id()
    }
...
#[cfg(feature = "spanned_tree")]
impl boseiju_span::Spanned for ScryKeywordAction {
...
impl Default for ScryKeywordAction {
    fn default() -> Self {
        Self {
