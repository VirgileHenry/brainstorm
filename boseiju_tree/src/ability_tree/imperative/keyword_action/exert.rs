...
impl crate::Node for ExertKeywordAction {
    fn node_id(&self) -> usize {
        use crate::node_kind::KeywordActionNodeKind;
        use idris::Idris;

        crate::NodeKind::KeywordAction(KeywordActionNodeKind::Exert).id()
    }
...
#[cfg(feature = "spanned_tree")]
impl boseiju_span::Spanned for ExertKeywordAction {
...
impl Default for ExertKeywordAction {
    fn default() -> Self {
        Self {
