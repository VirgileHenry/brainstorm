...
impl crate::Node for SurveilKeywordAction {
    fn node_id(&self) -> usize {
        use crate::node_kind::KeywordActionNodeKind;
        use idris::Idris;

        crate::NodeKind::KeywordAction(KeywordActionNodeKind::Surveil).id()
    }
    ...
    fn node_tag(&self) -> &'static str {
        "surveil keyword ability"
    }
}

#[cfg(feature = "spanned_tree")]
impl boseiju_span::Spanned for SurveilKeywordAction {
...
impl Default for SurveilKeywordAction {
    fn default() -> Self {
        Self {
