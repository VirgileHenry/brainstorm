...
impl crate::Node for EchoKeywordAbility {
    fn node_id(&self) -> usize {
        use crate::node_kind::KeywordAbilityNodeKind;
        use idris::Idris;

        crate::NodeKind::KeywordAbility(KeywordAbilityNodeKind::Echo).id()
    }
...
#[cfg(feature = "spanned_tree")]
impl boseiju_span::Spanned for EchoKeywordAbility {
...
impl Default for EchoKeywordAbility {
    fn default() -> Self {
        Self {
