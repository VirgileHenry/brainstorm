...
impl crate::Node for WarpKeywordAbility {
    fn node_id(&self) -> usize {
        use crate::node_kind::KeywordAbilityNodeKind;
        use idris::Idris;

        crate::NodeKind::KeywordAbility(KeywordAbilityNodeKind::Warp).id()
    }
...
#[cfg(feature = "spanned_tree")]
impl boseiju_span::Spanned for WarpKeywordAbility {
...
impl Default for WarpKeywordAbility {
    fn default() -> Self {
        Self {
