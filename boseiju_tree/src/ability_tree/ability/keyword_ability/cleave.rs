...
impl crate::Node for CleaveKeywordAbility {
    fn node_id(&self) -> usize {
        use crate::node_kind::KeywordAbilityNodeKind;
        use idris::Idris;

        crate::NodeKind::KeywordAbility(KeywordAbilityNodeKind::Cleave).id()
    }
...
#[cfg(feature = "spanned_tree")]
impl boseiju_span::Spanned for CleaveKeywordAbility {
...
impl Default for CleaveKeywordAbility {
    fn default() -> Self {
        Self {
