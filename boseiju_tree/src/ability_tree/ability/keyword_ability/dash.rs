...
impl crate::Node for DashKeywordAbility {
    fn node_id(&self) -> usize {
        use crate::node_kind::KeywordAbilityNodeKind;
        use idris::Idris;

        crate::NodeKind::KeywordAbility(KeywordAbilityNodeKind::Dash).id()
    }
...
#[cfg(feature = "spanned_tree")]
impl boseiju_span::Spanned for DashKeywordAbility {
...
impl Default for DashKeywordAbility {
    fn default() -> Self {
        Self {
