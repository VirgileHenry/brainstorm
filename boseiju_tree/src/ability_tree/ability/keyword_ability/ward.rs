...
impl crate::Node for WardKeywordAbility {
    fn node_id(&self) -> usize {
        use crate::node_kind::KeywordAbilityNodeKind;
        use idris::Idris;

        crate::NodeKind::KeywordAbility(KeywordAbilityNodeKind::Ward).id()
    }
...
#[cfg(feature = "spanned_tree")]
impl boseiju_span::Spanned for WardKeywordAbility {
...
impl Default for WardKeywordAbility {
    fn default() -> Self {
        Self {
