...
pub enum CardParseError {
    ...
    InvalidLayout(crate::card::layout::LayoutParseError),
}
...
impl From<crate::card::layout::LayoutParseError> for CardParseError {
    fn from(error: crate::card::layout::LayoutParseError) -> Self {
