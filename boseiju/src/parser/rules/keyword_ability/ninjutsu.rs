        ...
        reduction: |nodes: &[ParserNode]| match &nodes {
            &[
                ...
                keyword_ability: crate::ability_tree::ability::KeywordAbility {
                    keyword: crate::ability_tree::ability::keyword_ability::ExpandedKeywordAbility::Ninjutsu(
                        crate::ability_tree::ability::keyword_ability::NinjutsuKeywordAbility {
                            cost: crate::ability_tree::cost::Cost::ManaCost(mana_cost.clone()),
                            #[cfg(feature = "spanned_tree")]
                            span: ninjutsu_span.merge(&mana_cost.span),
                        },
                    ),
                    /* Fixme */
