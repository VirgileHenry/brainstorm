        ...
        reduction: |nodes: &[ParserNode]| match &nodes {
            &[
                ...
                keyword_ability: crate::ability_tree::ability::KeywordAbility {
                    keyword: crate::ability_tree::ability::keyword_ability::ExpandedKeywordAbility::Renown(
                        crate::ability_tree::ability::keyword_ability::RenownKeywordAbility {
                            amount: number.clone(),
                            #[cfg(feature = "spanned_tree")]
                            span: number.node_span().merge(renown_span),
                        },
                    ),
                    /* Fixme */
