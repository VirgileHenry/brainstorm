            ...
            &[
                ...
                imperative: crate::ability_tree::imperative::ImperativeKind::KeywordAction(
                    crate::ability_tree::imperative::KeywordAction {
                        keyword: crate::ability_tree::imperative::ExpandedKeywordAction::Manifest(
                            crate::ability_tree::imperative::manifest::ManifestKeywordAction {
                                card: card.clone(),
                                #[cfg(feature = "spanned_tree")]
                                span: card.node_span().merge(manifest_span),
                            },
                        ),
                        ability: crate::ability_tree::imperative::manifest::ability(
                            card,
                            #[cfg(feature = "spanned_tree")]
                            card.node_span().merge(manifest_span),
                        ),
                        #[cfg(feature = "spanned_tree")]
                        span: card.node_span().merge(manifest_span),
                    },
