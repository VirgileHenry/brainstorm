            ...
            &[
                ...
                imperative: crate::ability_tree::imperative::ImperativeKind::KeywordAction(
                    crate::ability_tree::imperative::KeywordAction {
                        keyword: crate::ability_tree::imperative::ExpandedKeywordAction::Play(
                            crate::ability_tree::imperative::play::PlayKeywordAction {
                                card: card.clone(),
                                #[cfg(feature = "spanned_tree")]
                                span: card.node_span().merge(play_span),
                            },
                        ),
                        ability: crate::ability_tree::imperative::play::ability(
                            card,
                            #[cfg(feature = "spanned_tree")]
                            card.node_span().merge(play_span),
                        ),
                        #[cfg(feature = "spanned_tree")]
                        span: card.node_span().merge(play_span),
                    },
