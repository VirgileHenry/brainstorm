            ...
            &[
                ...
                imperative: crate::ability_tree::imperative::ImperativeKind::KeywordAction(
                    crate::ability_tree::imperative::KeywordAction {
                        keyword: crate::ability_tree::imperative::ExpandedKeywordAction::Create(
                            crate::ability_tree::imperative::create::CreateKeywordAction {
                                amount: number.clone(),
                                token: token.clone(),
                                #[cfg(feature = "spanned_tree")]
                                span: token.node_span().merge(create_span),
                            },
                        ),
                        ability: crate::ability_tree::imperative::create::ability(
                            number,
                            token,
                            #[cfg(feature = "spanned_tree")]
                            token.node_span().merge(create_span),
                        ),
                        #[cfg(feature = "spanned_tree")]
                        span: token.node_span().merge(create_span),
                    },
