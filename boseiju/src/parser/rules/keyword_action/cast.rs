            ...
            &[
                ...
                imperative: crate::ability_tree::imperative::ImperativeKind::KeywordAction(
                    crate::ability_tree::imperative::KeywordAction {
                        keyword: crate::ability_tree::imperative::ExpandedKeywordAction::Cast(
                            crate::ability_tree::imperative::cast::CastKeywordAction {
                                spell: spell.clone(),
                                #[cfg(feature = "spanned_tree")]
                                span: spell.node_span().merge(cast_span),
                            },
                        ),
                        ability: crate::ability_tree::imperative::cast::ability(
                            spell,
                            #[cfg(feature = "spanned_tree")]
                            spell.node_span().merge(cast_span),
                        ),
                        #[cfg(feature = "spanned_tree")]
                        span: spell.node_span().merge(cast_span),
                    },
