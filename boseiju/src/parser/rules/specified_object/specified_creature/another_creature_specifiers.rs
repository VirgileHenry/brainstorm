...
pub fn rules() -> impl Iterator<Item = crate::parser::rules::ParserRule> {
    /* "another creature <creature specifiers>" another is special, it's a + other */
    /* Examples: "another creature you control" */
        ...
        reduction: |nodes: &[ParserNode]| match &nodes {
            &[
                ...
                creature: object::specified_object::SpecifiedCreature {
                    ...
                    specifiers: Some(
                        specifiers.add_factor_specifier(object::specified_object::CreatureSpecifier::Another(
                    ...
                    #[cfg(feature = "spanned_tree")]
                    span: specifiers.node_span().merge(another_span),
                },
            }),
        ...
        reduction: |nodes: &[ParserNode]| match &nodes {
            &[
                ...
                creature: object::specified_object::SpecifiedCreature {
                    ...
                    specifiers: Some(
                        specifiers
                            .add_factor_specifier(object::specified_object::CreatureSpecifier::Another(
                                object::specified_object::AnotherObjectSpecifier {
                                    #[cfg(feature = "spanned_tree")]
                                    span: *another_span,
                                },
