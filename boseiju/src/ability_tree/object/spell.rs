...
impl crate::ability_tree::AbilityTreeNode for Spell {
    fn node_id(&self) -> usize {
        use idris::Idris;
        crate::ability_tree::NodeKind::Spell.id()
    }
...
impl crate::ability_tree::span::Spanned for Spell {
...
#[cfg(feature = "parser")]
impl crate::utils::DummyInit for Spell {
    fn dummy_init() -> Self {
