...
impl AbilityTreeNode for ArtifactSubtype {
    ...
    fn children(&self) -> arrayvec::ArrayVec<&dyn AbilityTreeNode, MAX_CHILDREN_PER_NODE> {
        ...
        let child_id = NodeKind::MtgData(MtgDataNodeKind::ArtifactSubtype(self.artifact_subtype)).id();
...
#[cfg(feature = "spanned_tree")]
impl crate::ability_tree::span::Spanned for ArtifactSubtype {
...
impl crate::lexer::IntoToken for ArtifactSubtype {
    fn try_from_span(span: &crate::lexer::Span) -> Option<Self> {
        Some(Self {
            artifact_subtype: crate::utils::from_str_singular_or_plural(&span.text)?,
            #[cfg(feature = "spanned_tree")]
            span: span.into(),
        })
    }
