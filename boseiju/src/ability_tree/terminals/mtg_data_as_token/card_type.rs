...
impl AbilityTreeNode for CardType {
    ...
    fn children(&self) -> arrayvec::ArrayVec<&dyn AbilityTreeNode, MAX_CHILDREN_PER_NODE> {
        ...
        let child_id = NodeKind::MtgData(MtgDataNodeKind::CardType(self.card_type)).id();
...
#[cfg(feature = "spanned_tree")]
impl crate::ability_tree::span::Spanned for CardType {
...
impl crate::lexer::IntoToken for CardType {
    fn try_from_span(span: &crate::lexer::Span) -> Option<Self> {
        if let Some(card_type) = crate::utils::from_str_singular_or_plural(&span.text) {
            Some(Self {
                card_type,
                #[cfg(feature = "spanned_tree")]
                span: span.into(),
