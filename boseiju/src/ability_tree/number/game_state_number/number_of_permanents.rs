...
pub struct NumberOfPermanents {
    pub permanent: crate::ability_tree::object::PermanentReference,
    #[cfg(feature = "spanned_tree")]
    pub span: crate::ability_tree::span::TreeSpan,
}

impl AbilityTreeNode for NumberOfPermanents {
    fn node_id(&self) -> usize {
        use idris::Idris;
        crate::ability_tree::NodeKind::NumberOfPermanents.id()
    }
...
#[cfg(feature = "parser")]
impl crate::utils::DummyInit for NumberOfPermanents {
    fn dummy_init() -> Self {
        Self {
