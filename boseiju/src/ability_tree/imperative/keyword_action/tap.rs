...
impl crate::ability_tree::AbilityTreeNode for TapKeywordAction {
    fn node_id(&self) -> usize {
        use crate::ability_tree::tree_node::KeywordActionNodeKind;
        use idris::Idris;

        crate::ability_tree::NodeKind::KeywordAction(KeywordActionNodeKind::Tap).id()
    }
...
#[cfg(feature = "spanned_tree")]
impl crate::ability_tree::span::Spanned for TapKeywordAction {
...
#[cfg(feature = "parser")]
impl crate::utils::DummyInit for TapKeywordAction {
    fn dummy_init() -> TapKeywordAction {
        Self {
