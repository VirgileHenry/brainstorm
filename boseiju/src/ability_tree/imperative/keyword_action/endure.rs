...
impl crate::ability_tree::AbilityTreeNode for EndureKeywordAction {
    fn node_id(&self) -> usize {
        use crate::ability_tree::tree_node::KeywordActionNodeKind;
        use idris::Idris;

        crate::ability_tree::NodeKind::KeywordAction(KeywordActionNodeKind::Endure).id()
    }
...
#[cfg(feature = "spanned_tree")]
impl crate::ability_tree::span::Spanned for EndureKeywordAction {
...
#[cfg(feature = "parser")]
impl crate::utils::DummyInit for EndureKeywordAction {
    fn dummy_init() -> EndureKeywordAction {
        Self {
