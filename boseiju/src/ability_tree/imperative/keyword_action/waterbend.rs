...
impl crate::ability_tree::AbilityTreeNode for WaterbendKeywordAction {
    fn node_id(&self) -> usize {
        use crate::ability_tree::tree_node::KeywordActionNodeKind;
        use idris::Idris;

        crate::ability_tree::NodeKind::KeywordAction(KeywordActionNodeKind::Waterbend).id()
    }
...
#[cfg(feature = "spanned_tree")]
impl crate::ability_tree::span::Spanned for WaterbendKeywordAction {
...
#[cfg(feature = "parser")]
impl crate::utils::DummyInit for WaterbendKeywordAction {
    fn dummy_init() -> WaterbendKeywordAction {
        Self {
