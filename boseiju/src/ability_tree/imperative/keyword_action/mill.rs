...
impl crate::ability_tree::AbilityTreeNode for MillKeywordAction {
    fn node_id(&self) -> usize {
        use crate::ability_tree::tree_node::KeywordActionNodeKind;
        use idris::Idris;

        crate::ability_tree::NodeKind::KeywordAction(KeywordActionNodeKind::Mill).id()
    }
...
#[cfg(feature = "spanned_tree")]
impl crate::ability_tree::span::Spanned for MillKeywordAction {
...
#[cfg(feature = "parser")]
impl crate::utils::DummyInit for MillKeywordAction {
    fn dummy_init() -> MillKeywordAction {
        Self {
