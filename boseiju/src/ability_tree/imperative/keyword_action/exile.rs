...
impl crate::ability_tree::AbilityTreeNode for ExileKeywordAction {
    fn node_id(&self) -> usize {
        use crate::ability_tree::tree_node::KeywordActionNodeKind;
        use idris::Idris;

        crate::ability_tree::NodeKind::KeywordAction(KeywordActionNodeKind::Exile).id()
    }
...
#[cfg(feature = "spanned_tree")]
impl crate::ability_tree::span::Spanned for ExileKeywordAction {
...
#[cfg(feature = "parser")]
impl crate::utils::DummyInit for ExileKeywordAction {
    fn dummy_init() -> ExileKeywordAction {
        Self {
