...
impl crate::ability_tree::AbilityTreeNode for CastKeywordAction {
    fn node_id(&self) -> usize {
        use crate::ability_tree::tree_node::KeywordActionNodeKind;
        use idris::Idris;

        crate::ability_tree::NodeKind::KeywordAction(KeywordActionNodeKind::Cast).id()
    }
...
#[cfg(feature = "spanned_tree")]
impl crate::ability_tree::span::Spanned for CastKeywordAction {
...
#[cfg(feature = "parser")]
impl crate::utils::DummyInit for CastKeywordAction {
    fn dummy_init() -> CastKeywordAction {
        Self {
