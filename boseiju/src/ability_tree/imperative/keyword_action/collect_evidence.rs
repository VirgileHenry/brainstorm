...
impl crate::ability_tree::AbilityTreeNode for CollectEvidenceKeywordAction {
    fn node_id(&self) -> usize {
        use crate::ability_tree::tree_node::KeywordActionNodeKind;
        use idris::Idris;

        crate::ability_tree::NodeKind::KeywordAction(KeywordActionNodeKind::CollectEvidence).id()
    }
...
#[cfg(feature = "spanned_tree")]
impl crate::ability_tree::span::Spanned for CollectEvidenceKeywordAction {
...
#[cfg(feature = "parser")]
impl crate::utils::DummyInit for CollectEvidenceKeywordAction {
    fn dummy_init() -> CollectEvidenceKeywordAction {
        Self {
