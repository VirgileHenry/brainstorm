...
impl crate::ability_tree::AbilityTreeNode for ManifestKeywordAction {
    fn node_id(&self) -> usize {
        use crate::ability_tree::tree_node::KeywordActionNodeKind;
        use idris::Idris;

        crate::ability_tree::NodeKind::KeywordAction(KeywordActionNodeKind::Manifest).id()
    }
...
#[cfg(feature = "spanned_tree")]
impl crate::ability_tree::span::Spanned for ManifestKeywordAction {
...
#[cfg(feature = "parser")]
impl crate::utils::DummyInit for ManifestKeywordAction {
    fn dummy_init() -> ManifestKeywordAction {
        Self {
