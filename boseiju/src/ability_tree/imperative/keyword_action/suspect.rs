...
impl crate::ability_tree::AbilityTreeNode for SuspectKeywordAction {
    fn node_id(&self) -> usize {
        use crate::ability_tree::tree_node::KeywordActionNodeKind;
        use idris::Idris;

        crate::ability_tree::NodeKind::KeywordAction(KeywordActionNodeKind::Suspect).id()
    }
...
#[cfg(feature = "spanned_tree")]
impl crate::ability_tree::span::Spanned for SuspectKeywordAction {
...
#[cfg(feature = "parser")]
impl crate::utils::DummyInit for SuspectKeywordAction {
    fn dummy_init() -> SuspectKeywordAction {
        Self {
