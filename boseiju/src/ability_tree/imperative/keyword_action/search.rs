...
impl crate::ability_tree::AbilityTreeNode for SearchKeywordAction {
    fn node_id(&self) -> usize {
        use crate::ability_tree::tree_node::KeywordActionNodeKind;
        use idris::Idris;

        crate::ability_tree::NodeKind::KeywordAction(KeywordActionNodeKind::Search).id()
    }
...
#[cfg(feature = "spanned_tree")]
impl crate::ability_tree::span::Spanned for SearchKeywordAction {
...
#[cfg(feature = "parser")]
impl crate::utils::DummyInit for SearchKeywordAction {
    fn dummy_init() -> SearchKeywordAction {
        Self {
