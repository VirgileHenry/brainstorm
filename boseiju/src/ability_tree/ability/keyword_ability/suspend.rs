...
impl crate::ability_tree::AbilityTreeNode for SuspendKeywordAbility {
    fn node_id(&self) -> usize {
        use crate::ability_tree::tree_node::KeywordAbilityNodeKind;
        use idris::Idris;

        crate::ability_tree::NodeKind::KeywordAbility(KeywordAbilityNodeKind::Suspend).id()
    }
...
#[cfg(feature = "spanned_tree")]
impl crate::ability_tree::span::Spanned for SuspendKeywordAbility {
...
#[cfg(feature = "parser")]
impl crate::utils::DummyInit for SuspendKeywordAbility {
    fn dummy_init() -> Self {
        Self {
