...
impl crate::ability_tree::AbilityTreeNode for FreerunningKeywordAbility {
    fn node_id(&self) -> usize {
        use crate::ability_tree::tree_node::KeywordAbilityNodeKind;
        use idris::Idris;

        crate::ability_tree::NodeKind::KeywordAbility(KeywordAbilityNodeKind::Freerunning).id()
    }
...
#[cfg(feature = "spanned_tree")]
impl crate::ability_tree::span::Spanned for FreerunningKeywordAbility {
...
#[cfg(feature = "parser")]
impl crate::utils::DummyInit for FreerunningKeywordAbility {
    fn dummy_init() -> FreerunningKeywordAbility {
        Self {
