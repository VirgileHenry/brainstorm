...
pub enum ParserError {
    ...
    FailedToApplyRule {
        ...
        for_rule: crate::ability_tree::rules::ParserRuleDeclarationLocation,
    },
...
impl ParserError {
    pub(super) fn from_earley_table(table: &super::EarleyTable, tokens: &[boseiju_lexer::Token]) -> Self {
        ...
        for (expecting_token, for_nodes) in last_non_empty_row.uncompleted_items.iter() {
            ...
            if *expecting_token < boseiju_lexer::Token::COUNT {
...
pub struct PossibleExpectedToken {
    pub expected: usize,
    pub for_nodes: Vec<(usize, crate::ability_tree::rules::ParserRuleDeclarationLocation)>,
}
