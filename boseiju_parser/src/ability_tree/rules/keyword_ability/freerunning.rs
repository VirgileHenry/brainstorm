        ...
        reduction: |nodes: &[ParserNode]| match &nodes {
            &[
                ParserNode::LexerToken(Token::KeywordAbility(intermediate::KeywordAbility {
                    keyword_ability: mtg_data::KeywordAbility::Freerunning,
                    #[cfg(feature = "spanned_tree")]
                        span: freerunning_span,
                })),
                ParserNode::Cost { cost },
            ] => Ok(ParserNode::KeywordAbility {
                keyword_ability: boseiju_tree::ability_tree::ability::KeywordAbility {
                    keyword: boseiju_tree::ability_tree::ability::keyword_ability::ExpandedKeywordAbility::Freerunning(
                        boseiju_tree::ability_tree::ability::keyword_ability::FreerunningKeywordAbility {
                            cost: cost.clone(),
                            #[cfg(feature = "spanned_tree")]
                            span: freerunning_span.merge(&cost.span),
                        },
                    ),
                    /* Fixme */
