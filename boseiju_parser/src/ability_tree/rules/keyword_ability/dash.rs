    ...
    std::iter::once(ParserRule {
        expanded: RuleLhs::new(&[
            ParserNode::LexerToken(Token::KeywordAbility(intermediate::KeywordAbility {
                keyword_ability: mtg_data::KeywordAbility::Dash,
        ...
        reduction: |nodes: &[ParserNode]| match &nodes {
            &[
                ...
                keyword_ability: boseiju_tree::ability_tree::ability::KeywordAbility {
                    keyword: boseiju_tree::ability_tree::ability::keyword_ability::ExpandedKeywordAbility::Dash(
                        boseiju_tree::ability_tree::ability::keyword_ability::DashKeywordAbility {
                            cost: cost.clone(),
                            #[cfg(feature = "spanned_tree")]
                            span: dash_span.merge(&cost.span),
                        },
                    ),
                    /* Fixme */
