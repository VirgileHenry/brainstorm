        ...
        reduction: |nodes: &[ParserNode]| match &nodes {
            &[
                ParserNode::LexerToken(Token::KeywordAbility(intermediate::KeywordAbility {
                    keyword_ability: mtg_data::KeywordAbility::Reconfigure,
                    #[cfg(feature = "spanned_tree")]
                        span: reconfigure_span,
                })),
                ParserNode::Cost { cost },
            ] => Ok(ParserNode::KeywordAbility {
                keyword_ability: boseiju_tree::ability_tree::ability::KeywordAbility {
                    keyword: boseiju_tree::ability_tree::ability::keyword_ability::ExpandedKeywordAbility::Reconfigure(
                        boseiju_tree::ability_tree::ability::keyword_ability::ReconfigureKeywordAbility {
                            cost: cost.clone(),
                            #[cfg(feature = "spanned_tree")]
                            span: reconfigure_span.merge(&cost.span),
                        },
                    ),
                    /* Fixme */
