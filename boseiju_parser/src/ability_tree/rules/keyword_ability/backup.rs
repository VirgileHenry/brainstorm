    ...
    std::iter::once(ParserRule {
        expanded: RuleLhs::new(&[
            ParserNode::LexerToken(Token::KeywordAbility(intermediate::KeywordAbility {
                keyword_ability: mtg_data::KeywordAbility::Backup,
                #[cfg(feature = "spanned_tree")]
        ...
        reduction: |nodes: &[ParserNode]| match &nodes {
            &[
                ...
                keyword_ability: boseiju_tree::ability_tree::ability::KeywordAbility {
                    keyword: boseiju_tree::ability_tree::ability::keyword_ability::ExpandedKeywordAbility::Backup(
                        boseiju_tree::ability_tree::ability::keyword_ability::BackupKeywordAbility {
                            amount: number.clone(),
                            #[cfg(feature = "spanned_tree")]
                            span: number.span().merge(backup_span),
                        },
                    ),
                    /* Fixme */
