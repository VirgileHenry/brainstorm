        ...
        reduction: |nodes: &[ParserNode]| match &nodes {
            &[
                ...
                keyword_ability: boseiju_tree::ability_tree::ability::KeywordAbility {
                    keyword: boseiju_tree::ability_tree::ability::keyword_ability::ExpandedKeywordAbility::Crew(
                        boseiju_tree::ability_tree::ability::keyword_ability::CrewKeywordAbility {
                            amount: number.clone(),
                            #[cfg(feature = "spanned_tree")]
