        ...
        reduction: |nodes: &[ParserNode]| match &nodes {
            &[
                ...
                keyword_ability: boseiju_tree::ability_tree::ability::KeywordAbility {
                    keyword: boseiju_tree::ability_tree::ability::keyword_ability::ExpandedKeywordAbility::Flashback(
                        boseiju_tree::ability_tree::ability::keyword_ability::FlashbackKeywordAbility {
                            cost: cost.clone(),
                            #[cfg(feature = "spanned_tree")]
