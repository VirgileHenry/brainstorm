            ...
            &[
                ...
                imperative: boseiju_tree::ability_tree::imperative::ImperativeKind::KeywordAction(
                    boseiju_tree::ability_tree::imperative::KeywordAction {
                        keyword: boseiju_tree::ability_tree::imperative::ExpandedKeywordAction::Explore(
                            boseiju_tree::ability_tree::imperative::explore::ExploreKeywordAction {
                                creature: creature.clone(),
                                #[cfg(feature = "spanned_tree")]
                                span: creature.span().merge(explore_span),
                            },
                        ),
                        ability: boseiju_tree::ability_tree::imperative::explore::ability(
                            creature,
                            #[cfg(feature = "spanned_tree")]
                            creature.span().merge(explore_span),
                        ),
                        #[cfg(feature = "spanned_tree")]
                        span: creature.span().merge(explore_span),
                    },
