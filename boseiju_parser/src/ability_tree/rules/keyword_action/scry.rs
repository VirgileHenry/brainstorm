            ...
            &[
                ...
                imperative: boseiju_tree::ability_tree::imperative::ImperativeKind::KeywordAction(
                    boseiju_tree::ability_tree::imperative::KeywordAction {
                        keyword: boseiju_tree::ability_tree::imperative::ExpandedKeywordAction::Scry(
                            boseiju_tree::ability_tree::imperative::scry::ScryKeywordAction {
                                amount: number.clone(),
                                #[cfg(feature = "spanned_tree")]
                                span: number.span().merge(scry_span),
                            },
                        ),
                        ability: boseiju_tree::ability_tree::imperative::scry::ability(
                            number,
                            #[cfg(feature = "spanned_tree")]
                            number.span().merge(scry_span),
                        ),
                        #[cfg(feature = "spanned_tree")]
                        span: number.span().merge(scry_span),
                    },
