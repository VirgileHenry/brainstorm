            ...
            &[
                ...
                imperative: boseiju_tree::ability_tree::imperative::ImperativeKind::KeywordAction(
                    boseiju_tree::ability_tree::imperative::KeywordAction {
                        keyword: boseiju_tree::ability_tree::imperative::ExpandedKeywordAction::Waterbend(
                            boseiju_tree::ability_tree::imperative::waterbend::WaterbendKeywordAction {
                                amount: number.clone(),
                                #[cfg(feature = "spanned_tree")]
                                span: number.span().merge(waterbend_span),
                            },
                        ),
                        ability: boseiju_tree::ability_tree::imperative::waterbend::ability(
                            number,
                            #[cfg(feature = "spanned_tree")]
