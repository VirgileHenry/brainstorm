        ...
        expanded: RuleLhs::new(&[
            ParserNode::LexerToken(Token::TensedKeywordAction(intermediate::TensedKeywordAction {
                token: intermediate::KeywordAction {
                    keyword_action: mtg_data::KeywordAction::Earthbend,
                    #[cfg(feature = "spanned_tree")]
            ...
            &[
                ...
                imperative: boseiju_tree::ability_tree::imperative::ImperativeKind::KeywordAction(
                    boseiju_tree::ability_tree::imperative::KeywordAction {
                        keyword: boseiju_tree::ability_tree::imperative::ExpandedKeywordAction::Earthbend(
                            boseiju_tree::ability_tree::imperative::earthbend::EarthbendKeywordAction {
                                amount: number.clone(),
                                #[cfg(feature = "spanned_tree")]
                                span: number.span().merge(earthbend_span),
                            },
                        ),
                        ability: boseiju_tree::ability_tree::imperative::earthbend::ability(
                            number,
                            #[cfg(feature = "spanned_tree")]
                            number.span().merge(earthbend_span),
                        ),
                        #[cfg(feature = "spanned_tree")]
                        span: number.span().merge(earthbend_span),
                    },
