        ...
        expanded: RuleLhs::new(&[
            ParserNode::LexerToken(Token::TensedKeywordAction(intermediate::TensedKeywordAction {
                token: intermediate::KeywordAction {
                    keyword_action: mtg_data::KeywordAction::Detain,
                    #[cfg(feature = "spanned_tree")]
            ...
            &[
                ...
                imperative: boseiju_tree::ability_tree::imperative::ImperativeKind::KeywordAction(
                    boseiju_tree::ability_tree::imperative::KeywordAction {
                        keyword: boseiju_tree::ability_tree::imperative::ExpandedKeywordAction::Detain(
                            boseiju_tree::ability_tree::imperative::detain::DetainKeywordAction {
                                permanent: permanent.clone(),
                                #[cfg(feature = "spanned_tree")]
                                span: permanent.span().merge(detain_span),
                            },
                        ),
                        ability: boseiju_tree::ability_tree::imperative::detain::ability(
                            permanent,
                            #[cfg(feature = "spanned_tree")]
                            permanent.span().merge(detain_span),
                        ),
                        #[cfg(feature = "spanned_tree")]
                        span: permanent.span().merge(detain_span),
                    },
