            ...
            &[
                ...
                imperative: boseiju_tree::ability_tree::imperative::ImperativeKind::KeywordAction(
                    boseiju_tree::ability_tree::imperative::KeywordAction {
                        keyword: boseiju_tree::ability_tree::imperative::ExpandedKeywordAction::Play(
                            boseiju_tree::ability_tree::imperative::play::PlayKeywordAction {
                                card: card.clone(),
                                #[cfg(feature = "spanned_tree")]
                                span: card.span().merge(play_span),
                            },
                        ),
                        ability: boseiju_tree::ability_tree::imperative::play::ability(
                            card,
                            #[cfg(feature = "spanned_tree")]
                            card.span().merge(play_span),
                        ),
                        #[cfg(feature = "spanned_tree")]
                        span: card.span().merge(play_span),
                    },
