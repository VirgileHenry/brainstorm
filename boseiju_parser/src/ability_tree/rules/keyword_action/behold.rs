            ...
            &[
                ...
                imperative: boseiju_tree::ability_tree::imperative::ImperativeKind::KeywordAction(
                    boseiju_tree::ability_tree::imperative::KeywordAction {
                        keyword: boseiju_tree::ability_tree::imperative::ExpandedKeywordAction::Behold(
                            boseiju_tree::ability_tree::imperative::behold::BeholdKeywordAction {
                                amount: number.clone(),
                        ...
                        ability: boseiju_tree::ability_tree::imperative::behold::ability(
                            number,
                            subtype,
                            #[cfg(feature = "spanned_tree")]
