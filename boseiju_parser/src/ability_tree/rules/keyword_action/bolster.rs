            ...
            &[
                ...
                imperative: boseiju_tree::ability_tree::imperative::ImperativeKind::KeywordAction(
                    boseiju_tree::ability_tree::imperative::KeywordAction {
                        keyword: boseiju_tree::ability_tree::imperative::ExpandedKeywordAction::Bolster(
                            boseiju_tree::ability_tree::imperative::bolster::BolsterKeywordAction {
                                amount: number.clone(),
                                #[cfg(feature = "spanned_tree")]
                                span: number.span().merge(bolster_span),
                            },
                        ),
                        ability: boseiju_tree::ability_tree::imperative::bolster::ability(
                            number,
                            #[cfg(feature = "spanned_tree")]
                            number.span().merge(bolster_span),
                        ),
                        #[cfg(feature = "spanned_tree")]
                        span: number.span().merge(bolster_span),
                    },
