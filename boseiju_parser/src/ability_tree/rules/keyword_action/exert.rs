            ...
            &[
                ...
                imperative: boseiju_tree::ability_tree::imperative::ImperativeKind::KeywordAction(
                    boseiju_tree::ability_tree::imperative::KeywordAction {
                        keyword: boseiju_tree::ability_tree::imperative::ExpandedKeywordAction::Exert(
                            boseiju_tree::ability_tree::imperative::exert::ExertKeywordAction {
                                permanent: permanent.clone(),
                                #[cfg(feature = "spanned_tree")]
                                span: permanent.span().merge(exert_span),
                            },
                        ),
                        ability: boseiju_tree::ability_tree::imperative::exert::ability(
                            permanent,
                            #[cfg(feature = "spanned_tree")]
                            permanent.span().merge(exert_span),
                        ),
                        #[cfg(feature = "spanned_tree")]
                        span: permanent.span().merge(exert_span),
                    },
