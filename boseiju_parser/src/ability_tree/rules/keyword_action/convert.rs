        ...
        expanded: RuleLhs::new(&[
            ParserNode::LexerToken(Token::TensedKeywordAction(intermediate::TensedKeywordAction {
                token: intermediate::KeywordAction {
                    keyword_action: mtg_data::KeywordAction::Convert,
                    #[cfg(feature = "spanned_tree")]
            ...
            &[
                ...
                imperative: boseiju_tree::ability_tree::imperative::ImperativeKind::KeywordAction(
                    boseiju_tree::ability_tree::imperative::KeywordAction {
                        keyword: boseiju_tree::ability_tree::imperative::ExpandedKeywordAction::Convert(
                            boseiju_tree::ability_tree::imperative::convert::ConvertKeywordAction {
                                permanent: permanent.clone(),
                                #[cfg(feature = "spanned_tree")]
                                span: permanent.span().merge(convert_span),
                            },
                        ),
                        ability: boseiju_tree::ability_tree::imperative::convert::ability(
                            permanent,
                            #[cfg(feature = "spanned_tree")]
                            permanent.span().merge(convert_span),
                        ),
                        #[cfg(feature = "spanned_tree")]
                        span: permanent.span().merge(convert_span),
                    },
