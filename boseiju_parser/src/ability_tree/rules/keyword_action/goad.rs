            ...
            &[
                ...
                imperative: boseiju_tree::ability_tree::imperative::ImperativeKind::KeywordAction(
                    boseiju_tree::ability_tree::imperative::KeywordAction {
                        keyword: boseiju_tree::ability_tree::imperative::ExpandedKeywordAction::Goad(
                            boseiju_tree::ability_tree::imperative::goad::GoadKeywordAction {
                                creature: creature.clone(),
                                #[cfg(feature = "spanned_tree")]
                                span: creature.span().merge(goad_span),
                            },
                        ),
                        ability: boseiju_tree::ability_tree::imperative::goad::ability(
                            creature,
                            #[cfg(feature = "spanned_tree")]
                            creature.span().merge(goad_span),
                        ),
                        #[cfg(feature = "spanned_tree")]
                        span: creature.span().merge(goad_span),
                    },
