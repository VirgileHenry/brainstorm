            ...
            &[
                ...
                imperative: boseiju_tree::ability_tree::imperative::ImperativeKind::KeywordAction(
                    boseiju_tree::ability_tree::imperative::KeywordAction {
                        keyword: boseiju_tree::ability_tree::imperative::ExpandedKeywordAction::Create(
                            boseiju_tree::ability_tree::imperative::create::CreateKeywordAction {
                                amount: number.clone(),
                                token: token.clone(),
                                #[cfg(feature = "spanned_tree")]
                                span: token.span().merge(create_span),
                            },
                        ),
                        ability: boseiju_tree::ability_tree::imperative::create::ability(
                            number,
                            token,
                            #[cfg(feature = "spanned_tree")]
                            token.span().merge(create_span),
                        ),
                        #[cfg(feature = "spanned_tree")]
                        span: token.span().merge(create_span),
                    },
