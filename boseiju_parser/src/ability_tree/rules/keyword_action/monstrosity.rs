            ...
            &[
                ...
                imperative: boseiju_tree::ability_tree::imperative::ImperativeKind::KeywordAction(
                    boseiju_tree::ability_tree::imperative::KeywordAction {
                        keyword: boseiju_tree::ability_tree::imperative::ExpandedKeywordAction::Monstrosity(
                            boseiju_tree::ability_tree::imperative::monstrosity::MonstrosityKeywordAction {
                                amount: number.clone(),
                                #[cfg(feature = "spanned_tree")]
                                span: number.span().merge(monstrosity_span),
                            },
                        ),
                        ability: boseiju_tree::ability_tree::imperative::monstrosity::ability(
                            number,
                            #[cfg(feature = "spanned_tree")]
                            number.span().merge(monstrosity_span),
                        ),
                        #[cfg(feature = "spanned_tree")]
                        span: number.span().merge(monstrosity_span),
                    },
