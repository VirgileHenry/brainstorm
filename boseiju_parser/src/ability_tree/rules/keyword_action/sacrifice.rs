            ...
            &[
                ...
                imperative: boseiju_tree::ability_tree::imperative::ImperativeKind::KeywordAction(
                    boseiju_tree::ability_tree::imperative::KeywordAction {
                        keyword: boseiju_tree::ability_tree::imperative::ExpandedKeywordAction::Sacrifice(
                            boseiju_tree::ability_tree::imperative::sacrifice::SacrificeKeywordAction {
                                permanent: permanent.clone(),
                                #[cfg(feature = "spanned_tree")]
                                span: permanent.span().merge(sacrifice_span),
                            },
                        ),
                        ability: boseiju_tree::ability_tree::imperative::sacrifice::ability(
                            permanent,
                            #[cfg(feature = "spanned_tree")]
                            permanent.span().merge(sacrifice_span),
                        ),
                        #[cfg(feature = "spanned_tree")]
                        span: permanent.span().merge(sacrifice_span),
                    },
