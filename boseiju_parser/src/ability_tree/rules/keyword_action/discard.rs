            ...
            &[
                ...
                imperative: boseiju_tree::ability_tree::imperative::ImperativeKind::KeywordAction(
                    boseiju_tree::ability_tree::imperative::KeywordAction {
                        keyword: boseiju_tree::ability_tree::imperative::ExpandedKeywordAction::Discard(
                            boseiju_tree::ability_tree::imperative::discard::DiscardKeywordAction {
                                card: card.clone(),
                                #[cfg(feature = "spanned_tree")]
                                span: card.span().merge(discard_span),
                            },
                        ),
                        ability: boseiju_tree::ability_tree::imperative::discard::ability(
                            card,
                            #[cfg(feature = "spanned_tree")]
                            card.span().merge(discard_span),
                        ),
                        #[cfg(feature = "spanned_tree")]
                        span: card.span().merge(discard_span),
                    },
