            ...
            &[
                ...
                imperative: boseiju_tree::ability_tree::imperative::ImperativeKind::KeywordAction(
                    boseiju_tree::ability_tree::imperative::KeywordAction {
                        keyword: boseiju_tree::ability_tree::imperative::ExpandedKeywordAction::Surveil(
                            boseiju_tree::ability_tree::imperative::surveil::SurveilKeywordAction {
                                amount: number.clone(),
                                #[cfg(feature = "spanned_tree")]
                                span: number.span().merge(surveil_span),
                            },
                        ),
                        ability: boseiju_tree::ability_tree::imperative::surveil::ability(
                            number,
                            #[cfg(feature = "spanned_tree")]
                            number.span().merge(surveil_span),
                        ),
                        #[cfg(feature = "spanned_tree")]
                        span: number.span().merge(surveil_span),
                    },
