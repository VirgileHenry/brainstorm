            ...
            &[
                ...
                imperative: boseiju_tree::ability_tree::imperative::ImperativeKind::KeywordAction(
                    boseiju_tree::ability_tree::imperative::KeywordAction {
                        keyword: boseiju_tree::ability_tree::imperative::ExpandedKeywordAction::Discover(
                            boseiju_tree::ability_tree::imperative::discover::DiscoverKeywordAction {
                                amount: number.clone(),
                                #[cfg(feature = "spanned_tree")]
                                span: number.span().merge(discover_span),
                            },
                        ),
                        ability: boseiju_tree::ability_tree::imperative::discover::ability(
                            number,
                            #[cfg(feature = "spanned_tree")]
                            number.span().merge(discover_span),
                        ),
                        #[cfg(feature = "spanned_tree")]
                        span: number.span().merge(discover_span),
                    },
