            ...
            &[
                ...
                imperative: boseiju_tree::ability_tree::imperative::ImperativeKind::KeywordAction(
                    boseiju_tree::ability_tree::imperative::KeywordAction {
                        keyword: boseiju_tree::ability_tree::imperative::ExpandedKeywordAction::Incubate(
                            boseiju_tree::ability_tree::imperative::incubate::IncubateKeywordAction {
                                amount: number.clone(),
                                #[cfg(feature = "spanned_tree")]
                                span: number.span().merge(incubate_span),
                            },
                        ),
                        ability: boseiju_tree::ability_tree::imperative::incubate::ability(
                            number,
                            #[cfg(feature = "spanned_tree")]
