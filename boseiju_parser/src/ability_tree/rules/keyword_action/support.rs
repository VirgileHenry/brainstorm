        ...
        expanded: RuleLhs::new(&[
            ParserNode::LexerToken(Token::TensedKeywordAction(intermediate::TensedKeywordAction {
                token: intermediate::KeywordAction {
                    keyword_action: mtg_data::KeywordAction::Support,
                    #[cfg(feature = "spanned_tree")]
            ...
            &[
                ...
                imperative: boseiju_tree::ability_tree::imperative::ImperativeKind::KeywordAction(
                    boseiju_tree::ability_tree::imperative::KeywordAction {
                        keyword: boseiju_tree::ability_tree::imperative::ExpandedKeywordAction::Support(
                            boseiju_tree::ability_tree::imperative::support::SupportKeywordAction {
                                amount: number.clone(),
                                #[cfg(feature = "spanned_tree")]
                                span: number.span().merge(support_span),
                            },
                        ),
                        ability: boseiju_tree::ability_tree::imperative::support::ability(
                            number,
                            #[cfg(feature = "spanned_tree")]
                            number.span().merge(support_span),
                        ),
                        #[cfg(feature = "spanned_tree")]
                        span: number.span().merge(support_span),
                    },
