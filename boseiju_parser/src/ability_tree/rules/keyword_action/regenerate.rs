            ...
            &[
                ...
                imperative: boseiju_tree::ability_tree::imperative::ImperativeKind::KeywordAction(
                    boseiju_tree::ability_tree::imperative::KeywordAction {
                        keyword: boseiju_tree::ability_tree::imperative::ExpandedKeywordAction::Regenerate(
                            boseiju_tree::ability_tree::imperative::regenerate::RegenerateKeywordAction {
                                permanent: permanent.clone(),
                                #[cfg(feature = "spanned_tree")]
                                span: permanent.span().merge(regenerate_span),
                            },
                        ),
                        ability: boseiju_tree::ability_tree::imperative::regenerate::ability(
                            permanent,
                            #[cfg(feature = "spanned_tree")]
                            permanent.span().merge(regenerate_span),
                        ),
                        #[cfg(feature = "spanned_tree")]
                        span: permanent.span().merge(regenerate_span),
                    },
