        ...
        expanded: RuleLhs::new(&[
            ParserNode::LexerToken(Token::TensedKeywordAction(intermediate::TensedKeywordAction {
                token: intermediate::KeywordAction {
                    keyword_action: mtg_data::KeywordAction::Fateseal,
                    #[cfg(feature = "spanned_tree")]
            ...
            &[
                ...
                imperative: boseiju_tree::ability_tree::imperative::ImperativeKind::KeywordAction(
                    boseiju_tree::ability_tree::imperative::KeywordAction {
                        keyword: boseiju_tree::ability_tree::imperative::ExpandedKeywordAction::Fateseal(
                            boseiju_tree::ability_tree::imperative::fateseal::FatesealKeywordAction {
                                amount: number.clone(),
                                #[cfg(feature = "spanned_tree")]
                                span: number.span().merge(fateseal_span),
                            },
                        ),
                        ability: boseiju_tree::ability_tree::imperative::fateseal::ability(
                            number,
                            #[cfg(feature = "spanned_tree")]
                            number.span().merge(fateseal_span),
                        ),
                        #[cfg(feature = "spanned_tree")]
                        span: number.span().merge(fateseal_span),
                    },
