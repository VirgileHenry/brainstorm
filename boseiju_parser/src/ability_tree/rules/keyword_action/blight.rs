        ...
        expanded: RuleLhs::new(&[
            ParserNode::LexerToken(Token::TensedKeywordAction(intermediate::TensedKeywordAction {
                token: intermediate::KeywordAction {
                    keyword_action: mtg_data::KeywordAction::Blight,
                    #[cfg(feature = "spanned_tree")]
            ...
            &[
                ...
                imperative: boseiju_tree::ability_tree::imperative::ImperativeKind::KeywordAction(
                    boseiju_tree::ability_tree::imperative::KeywordAction {
                        keyword: boseiju_tree::ability_tree::imperative::ExpandedKeywordAction::Blight(
                            boseiju_tree::ability_tree::imperative::blight::BlightKeywordAction {
                                amount: number.clone(),
                                #[cfg(feature = "spanned_tree")]
                                span: number.span().merge(blight_span),
                            },
                        ),
                        ability: boseiju_tree::ability_tree::imperative::blight::ability(
                            number,
                            #[cfg(feature = "spanned_tree")]
                            number.span().merge(blight_span),
                        ),
                        #[cfg(feature = "spanned_tree")]
                        span: number.span().merge(blight_span),
                    },
